...
package net.mcreator.moswords.keybind;
...
import net.mcreator.moswords.procedure.ProcedureBlueUIBindOnKeyPressed;
import net.mcreator.moswords.MoSwords;
import net.mcreator.moswords.ElementsMoSwords;

@ElementsMoSwords.ModElement.Tag
public class KeyBindingBlueUIBind extends ElementsMoSwords.ModElement {
	private KeyBinding keys;
	public KeyBindingBlueUIBind(ElementsMoSwords instance) {
		super(instance, 25);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.blueuibind", Keyboard.KEY_Z, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				MoSwords.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureBlueUIBindOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
