...
import net.mcreator.moswords.procedure.ProcedureFoodUI;
...
public class GuiFreeFood extends ElementsMoSwords.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiFreeFood(ElementsMoSwords instance) {
		super(instance, 28);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("moswords:textures/freefood.png");
		@Override
		...
		public void initGui() {
			...
			this.guiTop = (this.height - 47) / 2;
			Keyboard.enableRepeatEvents(true);
			this.buttonList.clear();
			this.buttonList.add(new GuiButton(0, this.guiLeft + 16, this.guiTop + 15, 140, 20, "Free Blue Food"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureFoodUI.executeProcedure($_dependencies);
			}
		}
	}
