...
public class GuiFakeMossInventory extends ElementsMoSwords.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 44, 57) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 62, 57) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 80, 57) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 98, 57) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 116, 57) {
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 134, 57) {
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 152, 57) {
			}));
			this.customSlots.put(10, this.addSlotToContainer(new Slot(internal, 10, 8, 39) {
			}));
			this.customSlots.put(11, this.addSlotToContainer(new Slot(internal, 11, 26, 39) {
			}));
			this.customSlots.put(12, this.addSlotToContainer(new Slot(internal, 12, 44, 39) {
			}));
